...
class LichuangRBoard : public WifiBoard {
private:
...
public:
    LichuangRBoard() : boot_button_(BOOT_BUTTON_GPIO) {
    }

    virtual void Initialize() override {
        ESP_LOGI(TAG, "Initializing LichuangRBoard");
        InitializeI2c();
        InitializeSpi();
