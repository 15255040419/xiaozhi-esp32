...
class DoubleNetworkBoard : public Board {
private:
    // 使用基类指针存储当前活动的板卡
...
public:
    DoubleNetworkBoard(gpio_num_t ml307_tx_pin, gpio_num_t ml307_rx_pin, size_t ml307_rx_buffer_size = 4096);
    virtual ~DoubleNetworkBoard() = default;
